...
const createUser = catchAsyncErrors(async (req, res, next) => {
    ...
    user = await User.create({
        ...
        email,
        password,
        avatar: { public_id: "waitig", url: "waitig" },
    });
...
module.exports = { createUser,loginUser,logoutUser,forgotPassword ,resetPassword,userDetails,updatePassword,updateProfile,getAllUsers,getSingleUser,deleteUser,updateUserRole}